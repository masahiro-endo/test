    ...
    def __new__(cls):
        if cls._instance is None:
            ...
            cls._instance.obstacles = {
                '0-1':   NPC('0-1'  , 8, 19, 0,      MapMeth.talk_npc_0F1),
                '0-2':   NPC('0-2'  , 3, 19, 0,      MapMeth.talk_only_npc),
                '0-3':   NPC('0-3'  , 8, 28, 0,      MapMeth.talk_npc_0F3),
                '0-4':   NPC('0-4'  ,12, 19, 0,      MapMeth.talk_only_npc),
                '0-5':   NPC('0-5'  ,12, 28, 0,      MapMeth.talk_only_npc),
                '0-7': Chest('0-7'  ,11, 17, 0, 100, MapMeth.open_chest),
                '0-8':  Door('0-8'  , 4, 25, 0,      MapMeth.unlock_the_door),
                '0-9':   NPC('0-9'  , 5, 27, 0,      MapMeth.talk_only_npc),
                '1-1':  Door('1-1'  , 4,  6, 1,      MapMeth.unlock_the_door),  # ドア1（直行）
                '1-2':   NPC('1-2'  ,27,  3, 1,      MapMeth.talk_npc_1F2),
                '1-3': Chest('1-3'  , 7, 21, 1,  50, MapMeth.open_chest),
                '1-4': Chest('1-4'  , 8, 12, 1,   6, MapMeth.open_chest),
                '1-5': Chest('1-5'  ,12, 12, 1, 110, MapMeth.open_chest),
                '1-6': Chest('1-6'  ,16, 24, 1,  80, MapMeth.open_chest),
                '1-7': Chest('1-7'  ,24, 10, 1,   0, MapMeth.open_chest),  # カギ1
                '1-8':  Door('1-8'  ,13,  8, 1,      MapMeth.unlock_the_door),  # ドア2（宝部屋）
                '1-9': Chest('1-9'  , 8,  7, 1, 100, MapMeth.open_chest),
                '1-10':Chest('1-10' ,11,  7, 1, 100, MapMeth.open_chest),
                '1-11':Chest('1-11' , 8,  9, 1, 100, MapMeth.open_chest),
                '1-12':Chest('1-12' ,11,  9, 1, 100, MapMeth.open_chest),
                '2-1': Chest('2-1'  ,17, 10, 2, 170, MapMeth.open_chest),
                '2-2': Chest('2-2'  ,17, 20, 2,  73, MapMeth.open_chest),
                '2-3': Chest('2-3'  ,21, 10, 2,  25, MapMeth.open_chest),
                '2-4': Chest('2-4'  ,21, 20, 2, 256, MapMeth.open_chest),
                '2-5':   NPC('2-5'  ,21,  4, 2,      MapMeth.talk_npc_2F5),
                '2-6': Chest('2-6'  ,28, 28, 2,   0, MapMeth.open_chest),  # カギ2
                '2-7':  Door('2-7'  ,23,  4, 2,      MapMeth.unlock_the_door),  # ドア3（ヒール）
                '3-1':   NPC('3-1'  , 6, 22, 3,      MapMeth.talk_npc_3F1),
                '3-2':  Door('3-2'  , 4,  6, 3,      MapMeth.unlock_the_door),  # ドア4（直行）
                '3-3': Chest('3-3'  ,24, 12, 3,   0, MapMeth.open_chest),  # カギ3
                '3-4': Chest('3-4'  ,25, 12, 3,1000, MapMeth.open_chest),
                '3-5':  Door('3-5'  , 4, 10, 3,      MapMeth.unlock_the_door),  # ドア5
                '4-1': Chest('4-1'  ,16, 11, 4,   0, MapMeth.open_chest),  # カギ4
                '4-2': Chest('4-2'  ,18, 25, 4,   0, MapMeth.open_chest),  # カギ5
                '4-3':   NPC('4-3'  , 4, 27, 4,      MapMeth.talk_npc_4F3),
            }
            # 会話イベントデータ
            cls._instance.talks = {
